...
import java.sql.SQLException;
    ...
    public class FilmTest {
         ...
         */
        public void testConstructFilm() throws Exception {
         ...
         * @throws SQLException
         */
        public void testfindByIdBis() throws Exception {
         ...
         */
        public void testSaveAvecRealisateur() throws Exception {
         ...
         * @throws RealisateurAbsentException
         */
        public void testSaveAvecRealisateurRecupere() throws Exception {
         ...
         * @throws RealisateurAbsentException
         */
        public void test2Saves() throws Exception {
         ...
         * @throws RealisateurAbsentException
         */
        public void testNouveauRealSauve() throws Exception {
         ...
         * @throws RealisateurAbsentException
         */
        public void testChangeNomReal() throws Exception {
